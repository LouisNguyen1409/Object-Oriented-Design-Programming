...
public class Game {
    ...
    public static int activeZombies;
    ...
    static List<Bomb> boms = new ArrayList<Bomb>();
    static List<LogicalEntities> logicEntity = new ArrayList<>();

    public static void addBomb(Bomb b) {
        boms.add(b);
    }

    public static void addLogicalEntities(LogicalEntities e) {
        logicEntity.add(e);
    }

    public int tick() {
        boms = new ArrayList<Bomb>();
        logicEntity = new ArrayList<>();
        ...
        sub = nextTickSub;
        boms.stream().forEach(b -> b.notify(map));
