...
//         // this is due to the fact that only user1 can set the tags since user1 created
//         // the thread.
...
//         String[] expectedPosts = new String[] {
//                 "Yes, pineapple on pizza is the absolute best", "I think you misspelled pizza btw",
//         };
