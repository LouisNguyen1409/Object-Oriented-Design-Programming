...
//         try {
//             URI path = DegreeTest.class.getResource("/data/" + filename).toURI();
//             return new JSONObject(new String(Files.readAllBytes(Path.of(path))));
//         } catch (Exception e) {
//             return null;
//         }
//     }
...
//         JSONObject actual = d.distribute(degreeFilename, studentsFilename);
//         JSONObject expected = DegreeTest.parseJSON(expectedFilename);
